...
<!-- ***************** -->
            ...
            <!-- Panel Header Start-->
               <div class="bg-gray-300 flex-none h-12 md:h-14 flex justify-between items-center px-2 sm:px-5 text-lg border border-gray-400 shadow-md">
                    <div><p class="text-gray-500">Home / Add New Doctor</p></div>
                    <div>
            ...
            <!-- Panel Body Start-->
               <div class="bg-gray-200 grow p-5 border-x border-b border-gray-400 overflow-hidden">
                <div class="h-[100vh]">
                <!-- Common for all part -->
            ...
            <div class="h-[100vh] pb-52 overflow-scroll no-scrollbar">
                <form form action="insertDoctor.php" method="POST" enctype="multipart/form-data" class=" lg:max-w-5xl lg:mx-auto mb-10" >
                    <!-- form design Start-->
                     <div >
                        <!-- div1 -->
                    <div class="w-full flex flex-col gap-4">
                        <div class="flex flex-col"> 
                            <label class="add-form-lebel">Doctor's User Name :</label> 
                            <input class="add-form-input" type="text" placeholder="@alex95" name="user">
                        </div>
        
                        <div class="flex flex-col"> 
                            <label class="add-form-lebel">Doctor's Full Name :</label> 
